...
def load_pokec(dataset,sens_attr,predict_attr, path="../dataset/pokec_BIND/", label_number=1000,sens_number=500,seed=19,test_idx=False):
    """Load data"""
    print('Loading {} dataset from {}'.format(dataset,path))
    print('edges files: ',  (path,"{}_relationship.txt".format(dataset)))
