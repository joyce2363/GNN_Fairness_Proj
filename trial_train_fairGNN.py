...
from src.trial_train_fairGNN_utils import load_data, accuracy,load_pokec
...
if args.dataset != 'nba':
    if args.dataset == 'pokec_z_fairGNN':
        dataset = 'region_job'
        sens_attr = "region"
        ...
        test_idx=False
    elif args.dataset == 'pokec_n_fairGNN':
        ...
        path="dataset/pokec_fairGNN/"
        test_idx=False
    elif args.dataset == 'pokec1_BIND':
        dataset = 'region_job_1_BIND'
        sens_attr = "region"
        predict_attr = "I_am_working_in_field"
        label_number = args.label_number
        sens_number = args.sens_number
        seed = 20
        path="dataset/pokec_BIND/"
        test_idx=False
    elif args.dataset == 'pokec2_BIND':
        dataset = 'region_job_2_BIND'
        sens_attr = "region"
        predict_attr = "I_am_working_in_field"
        label_number = args.label_number
        sens_number = args.sens_number
...
#%%
import dgl
from src.trial_train_fairGNN_utils import feature_norm
G = dgl.DGLGraph()
...
# /Users/beep/Desktop/combinedPapers/dataset/pokec_BIND/region_job_1_BIND_sens.npy
# model.estimator.load_state_dict(torch.load("src/checkpoint/GCN_sens_region_job_2_ns_200"))
# model.estimator.load_state_dict(torch.load("dataset/pokec_BIND/{}_sens.npy".format(dataset)))
# print("model.estimator: ", model.estimator.load_state_dict(np.load("dataset/pokec_BIND/region_job_1_BIND_sens.npy")))
# model.estimator.load_state_dict(torch.load("src/checkpoint/GCN_sens_{}_ns_{}".format(dataset,sens_number)))
if args.cuda:
    model.cuda()
